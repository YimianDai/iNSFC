...
iNSFCv2 在 MacTeX、Overleaf 和 [SpicyChai LaTeX](https://latex.spicychai.com/)（支持AI驱动的模板填充和实时PDF预览）上均可编译通过，且用于组内多位成员的 2023 年国家自然基金申请并未遇到问题。
